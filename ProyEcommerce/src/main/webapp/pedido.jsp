                            ...
                            <div class="contenido1 hidden">
                                ...
                                <div class="ui-envio">
                                    <div class="contenido-domicilio hidden" id="contenido-domicilio">
                                        <p>
                                            Los despachos a Bodegas solo son válidos para direcciones que
                                            se encuentran en la misma urbanización
                                        </p>
                                        <div class="dato-input whole">
                                    ...
                                    <div class="contenido-tienda hidden" id="contenido-tienda">
                                        <div class="direccion">
                                            ...
                                            <div class="info">
                                                <p class="titulo">Alicorp</p>
                                                <p>Av. Argentina N° 4793, Carmen de la Legua y Reinoso</p>
                                                <p>Lima</p>
                                                <p>Lima, Callao</p>
