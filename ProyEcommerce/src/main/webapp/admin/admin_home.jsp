...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <br>
            <h2 class="text-light text-center">¿Qué desea hacer <%=usuario.getNombre()%>?</h2>
            <br>
            <div class="row justify-content-center text-center align-items-center g-2">
                ...
                <div class="col text-bg-danger p-3" style="border-top-right-radius: 1rem; border-bottom-right-radius: 1rem;">
                    <h5>Gráficos</h5>
                    <hr>
                    <small class="text-justify">Verifica el estado de ventas y realiza un seguimiento de actividad de la tienda</small>
                    <br>
                    <a href="/BodegaJavaWeb/admin/admin_home_graficos.jsp" class="btn btn-primary" style="margin-top: 2.70rem; margin-bottom: 2.70rem">Visualizar Gráficos</a>
                </div>
            </div>
        </div>
