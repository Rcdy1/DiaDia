            ...
            success: function() {
                ...
                newEl.innerHTML = `
                    <p>
                        ...
                        Se agrego <span>${nombre}</span><br>(<span>${precio}</span>) al Listado de pedido!
                    </p>
                `;
                document.getElementById('fixed').append(newEl);
                var btnListado = document.getElementById("carrito-header");
                btnListado.classList.remove('carrito')
                btnListado.classList.add('carrito-next-list')
